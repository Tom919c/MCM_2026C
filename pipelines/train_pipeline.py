...
from src.bayesian_model.data_utils import load_mock_data, load_data, validate_data, filter_data
from src.bayesian_model.model import build_model, train, extract_posterior, compute_metrics, generate_output
...
if __name__ == "__main__":
    ...
    save_data(datas, 'data/models/training_results.pkl')
    print("Done!")
